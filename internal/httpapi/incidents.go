...
func (a *API) listAudit(w http.ResponseWriter, r *http.Request) {
	...
	if err := a.Store.AppendAudit(r.Context(), audit.Record{ActorID: actor.UserID, ActorRole: string(actor.Role), Action: "audit.viewed",
		ObjectType: "incident", ObjectID: incident.PublicID, Result: audit.Succeeded, RequestID: actor.RequestID, CreatedAt: time.Now().UTC()}); err != nil {
		a.writeError(w, r, err)
		return
	}
