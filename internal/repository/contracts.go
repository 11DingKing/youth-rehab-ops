...
type PlanPublicationResult struct {
	Version domain.RehabPlanVersion
	Err     error
}
...
type CareStore interface {
	...
	StartPlanVersionPublication(context.Context, domain.Actor, int64, int64, domain.RehabPlanVersion) <-chan PlanPublicationResult
